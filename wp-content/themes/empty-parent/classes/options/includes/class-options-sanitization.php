...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'options' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'options' ),
		'repeat-y'  => __( 'Repeat Vertically', 'options' ),
		'repeat'    => __( 'Repeat All', 'options' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'options' ),
		'top center'    => __( 'Top Center', 'options' ),
		'top right'     => __( 'Top Right', 'options' ),
		'center left'   => __( 'Middle Left', 'options' ),
		'center center' => __( 'Middle Center', 'options' ),
		'center right'  => __( 'Middle Right', 'options' ),
		'bottom left'   => __( 'Bottom Left', 'options' ),
		'bottom center' => __( 'Bottom Center', 'options' ),
		'bottom right'  => __( 'Bottom Right', 'options')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'options' ),
		'fixed'  => __( 'Fixed in Place', 'options')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'options' ),
		'italic'      => __( 'Italic', 'options' ),
		'bold'        => __( 'Bold', 'options' ),
		'bold italic' => __( 'Bold Italic', 'options' )
		);
